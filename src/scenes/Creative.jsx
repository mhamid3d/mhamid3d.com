		...
		<section id="creative work" className="pt-10 pb-48">
						...
						>
							<div className="flex flex-col items-center hover:scale-110 transition-all">
								<img
									...
									alt="Across The Spider-Verse (2023) Poster"
								></img>
								<h4 className="mt-5 text-sm font-bold">
						...
						>
							<div className="flex flex-col items-center hover:scale-110 transition-all">
								<img
									...
									alt="Ron's Gone Wrong (2021) Poster"
								></img>
								<h4 className="mt-5 text-sm font-bold">
						...
						>
							<div className="flex flex-col items-center">
								<img
									...
									alt="Pokémon Detective Pikachu (2019) Poster"
								></img>
								<h4 className="mt-5 text-sm font-bold">
						...
						>
							<div className="flex flex-col items-center">
								<img
									...
									alt="Wonder Woman 1984 (2020) Poster"
								></img>
								<h4 className="mt-5 text-sm font-bold">
			...
			>
				<div className="relative pt-[56.25%] mt-16">
					{isAboveLarge ? (
						<iframe
							className="absolute inset-0 w-full h-full px-32"
							src="https://player.vimeo.com/video/343899153?h=66adebc231"
							frameborder="0"
							allowfullscreen
						></iframe>
					) : (
